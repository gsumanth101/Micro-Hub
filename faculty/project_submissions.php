...
if (isset($_SESSION["username"])) {
    ...
    $query = "SELECT * FROM micro_project WHERE mentor_name = ? LIMIT ?, ?";
    ...
    $countQuery = "SELECT COUNT(*) as total FROM micro_project WHERE mentor_name = ?";
                        ...
                        <tbody>
                            ...
                            while ($row = $studentResult->fetch_assoc()) {
                               ...
                               // echo "<td>" . $serial_number_start . "</td>";
                                ...
                                echo "<td>
                                        <button type='button' class='btn btn-info btn-sm viewBtn' onclick=\"window.location.href='view_submissions.php?studentId={$row['username']}'\">View</button><br>
