...
$micro_regdCount1 = 0;
$sqlregd1 = "SELECT COUNT(*) as count FROM micro_project";
$resultregd1 = $conn->query($sqlregd1);
if ($resultregd1 && $resultregd1->num_rows > 0) {
    $row1 = $resultregd1->fetch_assoc();
    $micro_regdCount1 = $row1['count'];
}
