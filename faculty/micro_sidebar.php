  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="micro_dashboard.php" class="nav-link">Home</a>
      </li>
     <!-- <li class="nav-item d-none d-sm-inline-block">
   ...
   <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="micro_dashboard.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="micro_student.php" class="nav-link">
              <i class="fa fa-light fa-caret-right nav-icon"></i>
              <p>Student Details</p>
            </a>
          </li>
...
<li class="nav-header">Experimental Elective</li>
      ...
      <li class="nav-item">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="micro_not_opened.php" class="nav-link">
              <i class="fa fa-light fa-caret-right nav-icon"></i>
              <p>Registrations</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="micro_project_submissions.php" class="nav-link">
              <i class="fa fa-light fa-caret-right nav-icon"></i>
...
<li class="nav-header">Micro Project Co-ordinator</li>
<li class="nav-item">
        <a href="#" class="nav-link">
          <i class="nav-icon fas fa fa-laptop aria-hidden="true"></i>
          <p>
