...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["login"])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM faculty WHERE BINARY username = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
			...
			switch($role)
			{
				case "Micro Project Co-ordinator":
					header("Location:micro_dashboard.php");
					break;
				case "CSP Co-ordinator":
			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-light box-shadow border-radius-12">
						...
						<form id="loginForm" action="facultylogin.php" method="POST">
