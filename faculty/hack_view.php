...
if (isset($_SESSION["username"])) {
    ...
    $sql = "SELECT * FROM hack_submission WHERE id = '$id' and fa_status is null";
    ...
    // Calculate credits based on event_type
    $credits = 0;
    switch ($row['event_type']) {
        case 'School Level (Industry Involvement)':
            $credits = 1;
            break;
        case 'Institute or University Level':
            $credits = 2;
            break;
        case 'State or National Level':
            $credits = 3;
            break;
    ...
    $update_query = "UPDATE hack_submission SET credits = ? WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        echo "Error updating credits: " . $stmt->error;
    }
