...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE phemesoft SET password = ? WHERE username = ?";
    ...
    if ($stmt->execute()) {
        if ($stmt->affected_rows > 0) {
            ...
            echo "<script>
                    ...
                    window.location.href = 'faculty.php'; // Redirect to another page after success
                </script>";
            ...
            echo "<script>
                    ...
                    window.location.href = 'faculty_password.php';
                </script>";
        }
    } else {
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3>phemesoft Password Update</h3>
                <div class="card-tools">
                </div>
            </div>
            <div class="card-body">

                <!-- Form for updating faculty password -->
