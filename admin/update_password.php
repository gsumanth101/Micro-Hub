...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlVerify = "SELECT password FROM Admin WHERE username = ?";
    ...
    if ($stmtVerify->fetch() && password_verify($currentPassword, $storedPassword)) {
        ...
        if ($stmtUpdate->execute()) {
            ...
            echo "<script>
                    ...
                    window.location.href = 'dashboard.php'; // Redirect to another page after success
                </script>";
            exit();
        } else {
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Admin Password Update</h3>
            </div>
            <div class="card-body">
