...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE coordinator SET password = ? WHERE username = ?";
    ...
    if ($stmt->execute()) {
        if ($stmt->affected_rows > 0) {
            ...
            echo "<script>
                    ...
                    window.location.href = 'coordinator.php'; // Redirect to another page after success
                </script>";
            ...
            echo "<script>
                    ...
                    window.location.href = 'coordinator_password.php';
                </script>";
        }
    } else {
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3>Coordinator Password Update</h3>
                <div class="card-tools">
                </div>
            </div>
            <div class="card-body">

                <!-- Form for updating coordinator password -->
