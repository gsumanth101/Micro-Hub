...
$sql = "SELECT * FROM micro_project WHERE acceptance_status='Accepted' $search_condition_sql LIMIT $offset, $results_per_page";
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h3>Micro Project Accepted List</h3>
                    </div>
                    <div class="col-md-6">
                        <!-- Small Search Bar -->
                        ...
                        <form method="post" action="download_accepted.php">
                            <button type="submit" class="btn btn-success float-right" name="download">Download Accepted</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
                ...
                <div class="table-responsive overflow-x-auto">
                    ...
                    <div class='modal-dialog' role='document'>
                        <div class='modal-content'>
                            ...
                            <p><strong>Tool(Other):</strong> {$row["other_tool_name"]}</p>
            ...
            <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                    <?php
                    $total_records_sql = "SELECT COUNT(*) FROM micro_project where acceptance_status='Accepted' $search_condition";
