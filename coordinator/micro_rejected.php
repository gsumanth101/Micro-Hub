...
$sql = "SELECT * FROM micro_project WHERE acceptance_status='Rejected' $search_condition_sql LIMIT $offset, $results_per_page";
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h3>Micro Project Rejected List</h3>
                    </div>
                    <div class="col-md-6">
                        <!-- Small Search Bar -->
                        ...
                        <form method="post" action="download_rejected.php">
                            <button type="submit" class="btn btn-success float-right" name="download">Download Rejected</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                    <?php
                    $total_records_sql = "SELECT COUNT(*) FROM micro_project where acceptance_status='Rejected' $search_condition";
