...
if (isset($_SESSION["username"])) {
    ...
    $sql = "SELECT * FROM hack_submission where slot = '$slot' and status = 'Accepted'";
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
            ...
            echo '<tr>
                ...
                <td class="text-right">
                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href=\'hack_view.php?id=' . $row['id'] . '\'">
        ...
        <div class="card-footer">
            <div class="row">
                ...
                <div class="col-md-6">
                    <button type="button" class="btn btn-danger" onclick="rejectSubmission()">Reject</button>
                </div>
            </div>
        </div>
        </div>
