...
$search_condition = $search_condition ? "WHERE team_id LIKE '%$search_condition%' OR team_name LIKE '%$search_condition%' OR mem_regd1 LIKE '%$search_condition%' OR mem_regd2  LIKE '%$search_condition%' OR mem_regd3 LIKE '%$search_condition%' OR mem_regd4 LIKE '%$search_condition%' OR guide_name LIKE '%$search_condition%' OR guide_username LIKE '%$search_condition%'" : '';

$sql = "SELECT * FROM caps_teams $search_condition LIMIT $offset, $results_per_page";
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-success float-right" onclick="window.location.href='export_teams.php'">Export</button>
                    </div>
                </div>
            </div>
        </div><!-- /.container-fluid -->
