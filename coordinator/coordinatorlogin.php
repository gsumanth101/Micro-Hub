...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["login"])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM coordinator WHERE BINARY username = ?");
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-light box-shadow border-radius-12">
						<div class="login-title">
							<h2 class="text-center text-primary" style="font-family: cursive;">Co-Ordinator Login</h2>
						</div>
						<form id="loginForm" action="coordinatorlogin.php" method="POST">
