        ...
        <div class="card">
                                    ...
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='editModalLabel{$serial_number_start}'>Edit Student</h5>
                                            ...
                                            <div class='modal-body'>
                                                <form action='edit_student.php' method='post'>
                                                    ...
                                                    <input type='text' class='form-control' id='editfaculty' name='editfaculty' value='{$row["faculty"]}'>
                                                     </div>
                                                    <div class='form-group'>
                                                        <label for='editSec'>Section:</label>
                                                        <select class='form-control' id='editSec' name='editSec' required>";
            ...
            <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                    <?php
                    $total_records_sql = "SELECT COUNT(*) FROM Student $search_condition";
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addfaculty" name="addfaculty" required>
                    </div>
                    <div class="form-group">
                        <label for="addSec">Section:</label>
                        <select class="form-control" id="addSec" name="addSec" required>
                            <?php
                            // Dropdown for sections
                            for ($i = 1; $i <= 29; $i++) {
                                $section = "S$i";
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="addYear" name="addYear" required>
                            <?php
                            // Dropdown for years
                            for ($i = 1; $i <= 4; $i++) {
