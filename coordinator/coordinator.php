...
$search_condition = $search_condition ? "WHERE username LIKE '%$search_condition%' name LIKE '%$search_condition%' OR email LIKE '%$search_condition%' OR Dept LIKE '%$search_condition%'" : '';
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="get" class="mb-3">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Search by Name, Email, or Department" name="search" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
