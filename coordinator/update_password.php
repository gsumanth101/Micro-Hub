...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlVerify = "SELECT password FROM coordinator WHERE username = ?";
    ...
    if ($stmtVerify->fetch() && password_verify($currentPassword, $storedPassword)) {
        ...
        $sqlUpdate = "UPDATE coordinator SET password = ? WHERE username = ?";
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Co-Ordinator Password Update</h3>
            </div>
            <div class="card-body">
