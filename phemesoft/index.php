...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["login"])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM phemesoft WHERE BINARY username = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            header("Location:intern_teams.php");
            exit();
        }
    }
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-light box-shadow border-radius-12">
						<div class="login-title">
							<h2 class="text-center text-primary" style="font-family: cursive;">phemesoft Login</h2>
						</div>
